...
`;
        ...
        console.log("Gemini Failed → Using Mock Data");
                ...
                sections: [
                    {
                        ...
                        questions: [
                            {
                                question: "Find the value of 24 × 7.",
                                difficulty: "Easy",
                                marks: 2,
                            },
                            {
            ...
            return JSON.stringify({
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        questions: [
                            {
                                question: "Write a short essay on teamwork.",
                                difficulty: "Medium",
                                marks: 5,
                            },
                            {
                                question: "Explain the importance of communication skills.",
                                difficulty: "Hard",
                                marks: 10,
                            },
                        ],
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        questions: [
                            ...
                            {
                                question: "Derive the equation of motion.",
                                difficulty: "Hard",
                                marks: 10,
                            },
                        ],
            ...
            sections: [
                {
                    ...
                    questions: [
                        {
                            question: "Define the core concept of the subject.",
                            difficulty: "Easy",
                            marks: 2,
                        },
                        {
                            question: "Explain one practical application of the subject.",
                            difficulty: "Medium",
                            marks: 5,
                        },
                    ],
